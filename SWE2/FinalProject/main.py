...
factory_1 = ShapeFactory()
factory_2 = ShapeFactory()

print(f"Factory 1 ID: {id(factory_1)}")
print(f"Factory 2 ID: {id(factory_2)}")
print(f"Are they the same instance? \n {factory_1 is factory_2}\n")
print("-" * 50)

print("### 2. Creating Shapes using Factory Method :")
